...
values ('thai gourmet', 10, 1, current_timestamp, current_timestamp, true, true, 1, '11111-222', 'fifth Avenue', '1000', 'downtown');
insert into tab_restaurants (name, shipping_costs, kitchen_id, created_at, updated_at, active, opened)
values ('thai delivery', 9.50, 1, current_timestamp, current_timestamp, true, true);
insert into tab_restaurants (name, shipping_costs, kitchen_id, created_at, updated_at, active, opened)
values ('tuk tuk indian food', 15, 2, current_timestamp, current_timestamp, true, true);
insert into tab_restaurants (name, shipping_costs, kitchen_id, created_at, updated_at, active, opened)
values ('java steakhouse', 12, 3, current_timestamp, current_timestamp, true, true);
insert into tab_restaurants (name, shipping_costs, kitchen_id, created_at, updated_at, active, opened)
values ('Uncle Sams Diner', 11, 4, current_timestamp, current_timestamp, true, true);
insert into tab_restaurants (name, shipping_costs, kitchen_id, created_at, updated_at, active, opened)
values ('Marys Bar', 6, 4, current_timestamp, current_timestamp, true, true);
...
insert into tab_users (name, email, password, created_at, updated_at) values ('User One', 'name1@domain.com', '123', current_timestamp, current_timestamp);
insert into tab_users (name, email, password, created_at, updated_at) values ('User Two', 'name2@domain.com', '123', current_timestamp, current_timestamp);
insert into tab_users (name, email, password, created_at, updated_at) values ('User Three', 'name3@domain.com', '123', current_timestamp, current_timestamp);
insert into tab_users (name, email, password, created_at, updated_at) values ('User Four', 'name4@domain.com', '123', current_timestamp, current_timestamp);
insert into tab_users (name, email, password, created_at, updated_at) values ('User Five', 'name5@domain.com', '123', current_timestamp, current_timestamp);
...
values (1, 1, 1, 78.9, 78.9, null, current_timestamp);
